...
import powerboard.powerboard.user.*;
...
class BoardServiceTest {
    ...
    void canNotAddUser() {
        ...
        assertThrows(ApiRequestException.class, () -> {
            boardService.addUser(nonExistingEmail, board.getId());
        });
    }
    @Test
    void canAddUser() {
        ...
        when(boardRepository.findById(board.getId())).thenReturn(Optional.of(board));
        when(boardRepository.save(any(Board.class))).thenReturn(board);
        boardService.addUser(email, board.getId());
    ...
    void canGetBoardUsers() {
        ...
        Set<UserDTO> result = boardService.getBoardUsers(board.getId());
